...
class TestClientInitialization:
    ...
    def test_client_initialization_with_defaults(self, mock_service_loader, mock_factory):
    ...
    @patch("ipsdk.platform_factory")
    @patch("asyncplatform.loader.services_loader.get")
    def test_client_initialization_with_all_parameters(self, mock_service_loader, mock_factory):
    ...
    @patch("ipsdk.platform_factory")
    @patch("asyncplatform.loader.services_loader.get")
    def test_client_initialization_filters_none_values(self, mock_service_loader, mock_factory):
        ...
        mock_factory.assert_called_once_with(want_async=True, host="platform.example.com")

    @patch("ipsdk.platform_factory")
    @patch("asyncplatform.loader.services_loader.get")
    def test_client_initialization_creates_context(self, mock_service_loader, mock_factory):
...
class TestClientContextManager:
    ...
    @patch("ipsdk.platform_factory")
    @patch("asyncplatform.loader.services_loader.get")
    async def test_client_aexit_calls_context_cleanup(self, mock_service_loader, mock_factory):
    ...
    @patch("ipsdk.platform_factory")
    @patch("asyncplatform.loader.services_loader.get")
    async def test_client_aexit_without_context(self, mock_service_loader, mock_factory):
    ...
    @patch("ipsdk.platform_factory")
    @patch("asyncplatform.loader.services_loader.get")
    async def test_client_aexit_with_exception_context(self, mock_service_loader, mock_factory):
    ...
    @patch("ipsdk.platform_factory")
    @patch("asyncplatform.loader.services_loader.get")
    async def test_client_context_manager_full_workflow(self, mock_service_loader, mock_factory):
...
class TestClientServiceLoading:
    ...
    @patch("ipsdk.platform_factory")
    @patch("asyncplatform.loader.services_loader.get")
    def test_client_loads_services_from_directory(self, mock_service_loader, mock_factory):
    ...
    @patch("ipsdk.platform_factory")
    @patch("asyncplatform.loader.services_loader.get")
    def test_client_stores_services_as_attributes(self, mock_service_loader, mock_factory):
...
class TestClientResourceLoading:
    ...
    def test_client_resource_raises_on_missing_resource(
        ...
        mock_factory.return_value = Mock()
        mock_service_loader.return_value = Mock()
        mock_resource_loader.side_effect = exceptions.AsyncPlatformError("Resource not found")
...
class TestClientIntegration:
    ...
    @patch("ipsdk.platform_factory")
    @patch("asyncplatform.loader.services_loader.get")
    def test_client_multiple_instances_are_independent(self, mock_service_loader, mock_factory):
