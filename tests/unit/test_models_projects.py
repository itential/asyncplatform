...
class TestProjectMember:
    ...
    def test_project_member_initialization_with_group(self):
        ...
        Raises:
            None
        """
        member = ProjectMember(name="Administrators", type="group", role="owner")
    ...
    def test_project_member_asdict_with_all_fields(self):
        ...
        member = ProjectMember(
            username="john.doe", name="John", type="account", role="editor"
        )
    ...
    def test_project_member_asdict_with_none_values(self):
        ...
        assert result == {"username": "john.doe", "type": "account", "role": "editor"}
    ...
    def test_project_member_asdict_group_member(self):
        ...
        assert result == {"name": "Admins", "type": "group", "role": "owner"}
