...
class TestLoaderIntegration:
    ...
    @patch("importlib.util.spec_from_file_location")
    @patch("importlib.util.module_from_spec")
    def test_loader_complete_workflow(self, mock_module_from_spec, mock_spec_from_file):
    ...
    @patch("importlib.util.spec_from_file_location")
    def test_loader_get_raises_error_when_spec_loader_is_none(
        self, mock_spec_from_file
    ):
