...
class Scanner:
    ...
    def __new__(cls, custom_patterns: dict[str, str] | None = None) -> Scanner:
        ...
        Args:
            custom_patterns: Additional patterns to scan for, where keys are
                pattern names and values are regex patterns.
    ...
    def __init__(self, custom_patterns: dict[str, str] | None = None) -> None:
        ...
        Args:
            custom_patterns: Additional patterns to scan for, where keys are
                pattern names and values are regex patterns. Only applied on
    ...
    def add_pattern(
        ...
        Args:
            ...
            redaction_func: Custom function to redact matches. If None, uses
                default redaction with pattern name.
...
def configure_scanner(
    ...
    Args:
        custom_patterns: Custom patterns to add to the scanner.
